...
const MovieRecommendations = () => {
  ...
  return (
    <div>
      <h1>MovieHouse.com</h1>
      <div className="search-bar">
        <input type="text" title='Search movie Name' placeholder="Search  movie" value={searchQuery} onChange={handleSearchChange} className='search-input'/>
        <button onClick={handleSearchSubmit} className="search-button" title='Search movies'>
          <AiOutlineSearch />
        </button>
      </div>
      <div className="filters">
        ...
        <select id="sort-by" value={sortBy} onChange={handleSortChange}>
          ...
          <option value="popularity.asc">Popularity Ascending Order</option>
